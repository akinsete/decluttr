...
mixin _$SettingsUiState {
 ...
 bool get hapticOn; bool get notifOn; bool get signedIn;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsUiState&&(identical(other.hapticOn, hapticOn) || other.hapticOn == hapticOn)&&(identical(other.notifOn, notifOn) || other.notifOn == notifOn)&&(identical(other.signedIn, signedIn) || other.signedIn == signedIn));
}


@override
int get hashCode => Object.hash(runtimeType,hapticOn,notifOn,signedIn);

@override
String toString() {
  return 'SettingsUiState(hapticOn: $hapticOn, notifOn: $notifOn, signedIn: $signedIn)';
}
...
@useResult
$Res call({
 bool hapticOn, bool notifOn, bool signedIn
});
...
/// Create a copy of SettingsUiState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hapticOn = null,Object? notifOn = null,Object? signedIn = null,}) {
  return _then(_self.copyWith(
hapticOn: null == hapticOn ? _self.hapticOn : hapticOn // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool hapticOn,  bool notifOn,  bool signedIn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsUiState() when $default != null:
return $default(_that.hapticOn,_that.notifOn,_that.signedIn);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool hapticOn,  bool notifOn,  bool signedIn)  $default,) {final _that = this;
switch (_that) {
case _SettingsUiState():
return $default(_that.hapticOn,_that.notifOn,_that.signedIn);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool hapticOn,  bool notifOn,  bool signedIn)?  $default,) {final _that = this;
switch (_that) {
case _SettingsUiState() when $default != null:
return $default(_that.hapticOn,_that.notifOn,_that.signedIn);case _:
  return null;
...
class _SettingsUiState implements SettingsUiState {
  const _SettingsUiState({this.hapticOn = true, this.notifOn = true, this.signedIn = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SettingsUiState&&(identical(other.hapticOn, hapticOn) || other.hapticOn == hapticOn)&&(identical(other.notifOn, notifOn) || other.notifOn == notifOn)&&(identical(other.signedIn, signedIn) || other.signedIn == signedIn));
}
...
/// Create a copy of SettingsUiState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? hapticOn = null,Object? notifOn = null,Object? signedIn = null,}) {
